...
declare class AFCompoundResponseSerializer extends AFHTTPResponseSerializer {
	...
	static compoundSerializerWithResponseSerializers(responseSerializers: NSArray<AFURLResponseSerialization>): AFCompoundResponseSerializer;
...
declare class AFHTTPSessionManager extends AFURLSessionManager implements NSCopying, NSSecureCoding {
	...
	DELETEParametersSuccessFailure(URLString: string, parameters: any, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	GETParametersProgressSuccessFailure(URLString: string, parameters: any, downloadProgress: (p1: NSProgress) => void, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	GETParametersSuccessFailure(URLString: string, parameters: any, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	HEADParametersSuccessFailure(URLString: string, parameters: any, success: (p1: NSURLSessionDataTask) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	PATCHParametersSuccessFailure(URLString: string, parameters: any, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	POSTParametersConstructingBodyWithBlockProgressSuccessFailure(URLString: string, parameters: any, block: (p1: AFMultipartFormData) => void, uploadProgress: (p1: NSProgress) => void, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	POSTParametersConstructingBodyWithBlockSuccessFailure(URLString: string, parameters: any, block: (p1: AFMultipartFormData) => void, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	POSTParametersProgressSuccessFailure(URLString: string, parameters: any, uploadProgress: (p1: NSProgress) => void, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	POSTParametersSuccessFailure(URLString: string, parameters: any, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;

	PUTParametersSuccessFailure(URLString: string, parameters: any, success: (p1: NSURLSessionDataTask, p2: any) => void, failure: (p1: NSURLSessionDataTask, p2: NSError) => void): NSURLSessionDataTask;
...
declare class AFImageDownloader extends NSObject {
	...
	downloadPrioritizaton: AFImageDownloadPrioritization;
...
declare class AFURLSessionManager extends NSObject implements NSCopying, NSSecureCoding, NSURLSessionDataDelegate, NSURLSessionDelegate, NSURLSessionDownloadDelegate, NSURLSessionTaskDelegate {
	...
	dataTaskWithRequestCompletionHandler(request: NSURLRequest, completionHandler: (p1: NSURLResponse, p2: any, p3: NSError) => void): NSURLSessionDataTask;
	...
	setTaskDidReceiveAuthenticationChallengeBlock(block: (p1: NSURLSession, p2: NSURLSessionTask, p3: NSURLAuthenticationChallenge, p4: interop.Pointer | interop.Reference<NSURLCredential>) => NSURLSessionAuthChallengeDisposition): void;
