	...
	export namespace fitcom {
		export namespace fancydownloader {
			export class DownloadCallback {
				 ...
				 */
				public constructor(implementation: { onProgress(param0: string, param1: number, param2: number, param3: number): void; onComplete(param0: string): void; onError(param0: string, param1: javalangException): void });
...
declare namespace co {
	export namespace fitcom {
		export namespace fancydownloader {
			export abstract class DownloadListenerUI extends co.fitcom.fancydownloader.DownloadListener {
				public onProgress(param0: string, param1: number, param2: number, param3: number): void;
				public onUIProgress(param0: string, param1: number, param2: number, param3: number): void;
	...
	export namespace fitcom {
		export namespace fancydownloader {
			export class Request {
				...
				public setListener(param0: co.fitcom.fancydownloader.DownloadListener): void;
				public constructor(param0: string, param1: javautilHashMap<any, any>, param2: co.fitcom.fancydownloader.DownloadListener);
	...
	export namespace fitcom {
		export namespace fancydownloader {
			export class Task {
				...
				public setDownloaderRequest(param0: co.fitcom.fancydownloader.Request): void;
			}
		}
	}
}
