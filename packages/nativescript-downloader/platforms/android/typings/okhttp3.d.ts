...
declare module okhttp3 {
	export class Authenticator extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { authenticate(param0: okhttp3.Route, param1: okhttp3.Response): okhttp3.Request; <clinit>(): void });
...
declare module okhttp3 {
	export class Call extends java.lang.Object implements java.lang.Cloneable {
		 ...
		 */
		public constructor(implementation: { request(): okhttp3.Request; execute(): okhttp3.Response; enqueue(param0: okhttp3.Callback): void; cancel(): void; isExecuted(): boolean; isCanceled(): boolean; clone(): okhttp3.Call });
	...
	export module Call {
		export class Factory extends java.lang.Object {
			 ...
			 */
			public constructor(implementation: { newCall(param0: okhttp3.Request): okhttp3.Call });
...
declare module okhttp3 {
	export class Callback extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { onFailure(param0: okhttp3.Call, param1: java.io.IOException): void; onResponse(param0: okhttp3.Call, param1: okhttp3.Response): void });
...
declare module okhttp3 {
	export class Connection extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { route(): okhttp3.Route; socket(): java.net.Socket; handshake(): okhttp3.Handshake; protocol(): okhttp3.Protocol });
...
declare module okhttp3 {
	export class CookieJar extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { saveFromResponse(param0: okhttp3.HttpUrl, param1: java.util.List<any>): void; loadForRequest(param0: okhttp3.HttpUrl): java.util.List<any>; <clinit>(): void });
...
declare module okhttp3 {
	export class Dns extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { lookup(param0: string): java.util.List<any>; <clinit>(): void });
...
declare module okhttp3 {
	export class Interceptor extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { intercept(param0: okhttp3.Interceptor.Chain): okhttp3.Response });
	...
	export module Interceptor {
		export class Chain extends java.lang.Object {
			 ...
			 */
			public constructor(implementation: { request(): okhttp3.Request; proceed(param0: okhttp3.Request): okhttp3.Response; connection(): okhttp3.Connection });
			public request(): okhttp3.Request;
...
declare module okhttp3 {
	export class WebSocket extends java.lang.Object {
		 ...
		 */
		public constructor(implementation: { request(): okhttp3.Request; queueSize(): number; send(param0: string): boolean; send(param0: okio.ByteString): boolean; close(param0: number, param1: string): boolean; cancel(): void });
	...
	export module WebSocket {
		export class Factory extends java.lang.Object {
			 ...
			 */
			public constructor(implementation: { newWebSocket(param0: okhttp3.Request, param1: okhttp3.WebSocketListener): okhttp3.WebSocket });
			public newWebSocket(param0: okhttp3.Request, param1: okhttp3.WebSocketListener): okhttp3.WebSocket;
		}
	}
}
	...
	export module internal {
		export module cache {
			export class InternalCache extends java.lang.Object {
				 ...
				 */
				public constructor(implementation: { get(param0: okhttp3.Request): okhttp3.Response; put(param0: okhttp3.Response): okhttp3.internal.cache.CacheRequest; remove(param0: okhttp3.Request): void; update(param0: okhttp3.Response, param1: okhttp3.Response): void; trackConditionalCacheHit(): void; trackResponse(param0: okhttp3.internal.cache.CacheStrategy): void });
	...
	export module internal {
		export module http {
			export class HttpCodec extends java.lang.Object {
				 ...
				 */
				public constructor(implementation: { createRequestBody(param0: okhttp3.Request, param1: number): okio.Sink; writeRequestHeaders(param0: okhttp3.Request): void; finishRequest(): void; readResponseHeaders(): okhttp3.Response.Builder; openResponseBody(param0: okhttp3.Response): okhttp3.ResponseBody; cancel(): void });
	...
	export module internal {
		export module http2 {
			export class PushObserver extends java.lang.Object {
				 ...
				 */
				public constructor(implementation: { onRequest(param0: number, param1: java.util.List<any>): boolean; onHeaders(param0: number, param1: java.util.List<any>, param2: boolean): boolean; onData(param0: number, param1: okio.BufferedSource, param2: number, param3: boolean): boolean; onReset(param0: number, param1: okhttp3.internal.http2.ErrorCode): void; <clinit>(): void });
		...
		export module ws {
			...
			export module WebSocketReader {
				export class FrameCallback extends java.lang.Object {
					 ...
					 */
					public constructor(implementation: { onReadMessage(param0: string): void; onReadMessage(param0: okio.ByteString): void; onReadPing(param0: okio.ByteString): void; onReadPong(param0: okio.ByteString): void; onReadClose(param0: number, param1: string): void });
					public onReadClose(param0: number, param1: string): void;
					public onReadMessage(param0: string): void;
					public onReadMessage(param0: okio.ByteString): void;
					public onReadPing(param0: okio.ByteString): void;
...
declare module okio {
	export class Sink extends java.lang.Object implements java.io.Closeable, java.io.Flushable {
		 ...
		 */
		public constructor(implementation: { write(param0: okio.Buffer, param1: number): void; flush(): void; timeout(): okio.Timeout; close(): void; close(): void; flush(): void; close(): void });
		public close(): void;
		public write(param0: okio.Buffer, param1: number): void;
		public flush(): void;
		public timeout(): okio.Timeout;
...
declare module okio {
	export class Source extends java.lang.Object implements java.io.Closeable {
		 ...
		 */
		public constructor(implementation: { read(param0: okio.Buffer, param1: number): number; timeout(): okio.Timeout; close(): void; close(): void; close(): void });
		public close(): void;
		public read(param0: okio.Buffer, param1: number): number;
		public timeout(): okio.Timeout;
	}
...
declare module org {
	export module fabiomsr {
		export module peercertificate {
